<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    {{-- JIKA BELUM LOGIN (TAMU): Tampilkan Tombol Login/Register --}}
                    <div class="flex gap-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-400 hover:text-white font-semibold transition">Log in</a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-400 hover:text-white font-semibold transition">Register</a>
                    </div>
                @endauth
            </div>
